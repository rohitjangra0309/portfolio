  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: github,
      url: 'https://github.com/rohitjangra0309?tab=repositories', 
    },
    {
      name: 'LinkedIn',
      icon: linkedin,
      url: 'https://www.linkedin.com/in/rohit-jangra-72453418b/', 
    },
    {
      name: 'Resume',
      icon: null, 
      url: 'https://drive.google.com/file/d/1GY2uuWWkQL8ajrIv5GNXd3et6PsaPt73/view?usp=sharing', 
    },
  ]
